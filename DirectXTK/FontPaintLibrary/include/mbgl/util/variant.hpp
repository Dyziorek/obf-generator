...
namespace mapbox { namespace util { namespace detail {
	...
	static const std::size_t invalid_value = std::size_t(-1);
...
{
    static const std::size_t index = std::is_same<T, First>::value
...
{
    static const std::size_t index = invalid_value;
};
...
{
    static const std::size_t index = std::is_convertible<T, First>::value
...
struct value_traits
{
    static const std::size_t direct_index = direct_type<T, Types...>::index;
...
{
    static const bool value = std::is_convertible<T, First>::value
...
//template<typename... Types>
//static const std::size_t data_aligned<Types...>(Types... member)
//{
//	return static_max<std::alignment_of<Types>...>::value;
//};
...
private:
	...
	static const std::size_t data_align = 16;
...
public:
    ...
    {
         std::size_t index = sizeof...(Types) - detail::value_traits<typename std::remove_reference<T>::type, Types...>::index - 1;
